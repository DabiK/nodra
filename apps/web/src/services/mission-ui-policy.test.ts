...
describe("mission UI policy for provider threads", () => {
  it("opens and activates an attached READY mission instead of launching a legacy run", () => {
    const policy = getMissionUiPolicy({
      mission: { id: "mission-1", projectId: null, title: "Attached", executionKind: "agent", state: "READY", version: 2, createdAt: "2026-01-01", updatedAt: "2026-01-01", runState: null, runStartedAt: null, lastAssistantMessage: null },
      hasAgentConfig: true,
  ...
  it("offers manual submit to validation for an ACTIVE agent mission whose run succeeded with result text", () => {
    const policy = getMissionUiPolicy({
      mission: { id: "mission-2", projectId: null, title: "Done run", executionKind: "agent", state: "ACTIVE", version: 3, createdAt: "2026-01-01", updatedAt: "2026-01-01", runState: null, runStartedAt: null, lastAssistantMessage: null },
      hasAgentConfig: true,
  ...
  it("enables manual submit for a stuck ACTIVE mission with a SUCCEEDED run but no assistant text", () => {
    const policy = getMissionUiPolicy({
      mission: { id: "mission-3", projectId: null, title: "Stuck", executionKind: "agent", state: "ACTIVE", version: 4, createdAt: "2026-01-01", updatedAt: "2026-01-01", runState: null, runStartedAt: null, lastAssistantMessage: null },
      hasAgentConfig: true,
      latestRunId: "run-finished",
      latestRunState: "SUCCEEDED",
      hasDelivery: false,
  ...
  it("keeps the provider conversation primary while an ACTIVE run is still running without a result", () => {
    const policy = getMissionUiPolicy({
      mission: { id: "mission-4", projectId: null, title: "Running", executionKind: "agent", state: "ACTIVE", version: 2, createdAt: "2026-01-01", updatedAt: "2026-01-01", runState: null, runStartedAt: null, lastAssistantMessage: null },
      hasAgentConfig: true,
  ...
  it("enables the conversation for a pipeline ACTIVE mission with a run but no provider session", () => {
    const policy = getMissionUiPolicy({
      mission: { id: "mission-pipe-1", projectId: null, title: "Pipeline step", executionKind: "agent", state: "ACTIVE", version: 2, createdAt: "2026-01-01", updatedAt: "2026-01-01", runState: null, runStartedAt: null, lastAssistantMessage: null },
      hasAgentConfig: true,
  ...
  it("enables the conversation for a DONE mission even without a run or session link", () => {
    const policy = getMissionUiPolicy({
      mission: { id: "mission-pipe-2", projectId: null, title: "Pipeline done", executionKind: "agent", state: "DONE", version: 4, createdAt: "2026-01-01", updatedAt: "2026-01-01", runState: null, runStartedAt: null, lastAssistantMessage: null },
      hasAgentConfig: true,
      latestRunId: null,
      latestRunState: null,
      hasDelivery: false,
  ...
  it("keeps the conversation disabled for a READY mission with no run and no provider session", () => {
    const policy = getMissionUiPolicy({
      mission: { id: "mission-fresh", projectId: null, title: "Fresh", executionKind: "agent", state: "READY", version: 1, createdAt: "2026-01-01", updatedAt: "2026-01-01", runState: null, runStartedAt: null, lastAssistantMessage: null },
      hasAgentConfig: true,
      latestRunId: null,
      latestRunState: null,
      hasDelivery: false,

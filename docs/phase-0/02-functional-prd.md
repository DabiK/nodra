...
| FR-12 | Providers et modèles | Codex et OpenCode sont initiaux. Le socle produit exigé est disponibilité, modèles, start, événements, stop, résultat, reprise, queue, steer, usage et pièces jointes. Le provider est choisi par mission, le défaut est configurable par projet, et aucun changement n'est automatique sans consentement. Copilot CLI/SDK est hors V1. |
